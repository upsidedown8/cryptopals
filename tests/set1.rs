...
fn challenge8() {
    ...
    let filename = "data/set1/challenge8.txt";
    let file = File::open(filename).unwrap();

    let mut ecb_line = String::new();

    'outer: for line in std::io::BufReader::new(file).lines() {
        let line = line.unwrap();
        let mut set = HashSet::new();

        let num_blocks = line.len() / (16 * 2);
        for i in 0..num_blocks {
            let block = String::from(&line[i * 32..(i + 1) * 32]);
    ...
    let expected_hex = "";

    assert_eq!(expected_hex, ecb_line);
}
